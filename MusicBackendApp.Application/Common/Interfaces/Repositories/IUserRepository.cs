...
public interface IUserRepository
{
    ...
    Task<Result<IQueryable<Domain.Entites.User>, Error>> GetByName(UserName name); //Було раніше Domain.Entites.User user
    ...
    Task UpdateUserAsync(Domain.Entites.User user); // Оновлює відстежувану сутність
